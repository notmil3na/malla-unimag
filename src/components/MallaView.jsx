...
const SEMESTER_CORTE = "2026-2";
const SEMESTER_START = new Date(2026, 7, 3); // 3 ago 2026
const SEMESTER_END = new Date(2026, 10, 28, 23, 59, 59, 999); // 28 nov 2026
...
function getSemesterCountdown(now = new Date()) {
